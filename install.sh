...
#
#  |════════════════════════════════════════════════════════════════════════════════════════════════════════════════|
#  • Autoscript AIO Lite Menu By XWAN Project                                          |
#  • FN Project Developer @myridtunnel | @mhmdrizki | @farell_aditya_ardian            |
...
wget -O sshd_config "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/sshd_config"
...
T̺͆O̺͆ M̺͆Y̺͆ S̺͆E̺͆R̺͆V̺͆E̺͆R̺͆ V͇̿I͇̿P͇̿ ] ★ </b></font><br><font color="#FFF00">ℝidwan 𝕊𝕥𝕠𝕣𝕖</font><br> <font color="#FF00FF">❖Ƭʜᴇ No DDOS</font><br> <font color="#FF0000">❖Ƭʜᴇ No Torrent</font><br> <font color="#FFB1C2">❖Ƭʜᴇ No Bokep </font><br> <font color="#FFFFFF">❖Ƭʜᴇ No Hacking</font><br>
<font color="#00FF00">❖Ƭʜᴇ No Mining</font><br> <font color="#00FF00">➳ᴹᴿ᭄ Oder / Trial :
https://wa.me/6287769315399 </font><br>
<font color="#00FFE2">क═══════क⊹⊱✫⊰⊹क═══════क</font><br></font><br><font color="FFFF00">❖Ƭʜᴇ WHATSAPP GRUP => https://whatsapp.com/channel/0029VaJ5qMBF6smxZiCF8U3N</font><br>
END
...
#Mengintall Xray
cd /etc/xray
wget -q -O config.json "https://raw.githubusercontent.com/okysmilee3/Xnew/main/config.json"
...
# Other
cd /usr/bin
wget -q -O m.zip "https://raw.githubusercontent.com/okysmilee3/Xnew/main/menu.zip"
unzip m.zip
rm -fr m.zip
chmod +x *
cd /usr/bin/xwan
...
#install latest xray
cd /usr/bin
wget -q https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/xray.zip
...
cd /etc/nginx 
rm -fr nginx.conf
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/okysmilee3/Xnew/main/nginx.conf"
cd

#detail nama perusahaan
country="ID"
state="Central Jawa"
locality="Kab. Kota Bogor"
organization="XWAN Project"
organizationalunit="99999"
commonname="KYT"
email="ridwanstoreaws@gmail.com"
...
# Install Slowdns
cd
wget -q https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/slowdns.sh; chmod +x slowdns.sh; ./slowdns.sh; rm -fr slowdns.sh

# Install Chisel Proxy
cd
wget -q https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/chisel.sh; chmod +x chisel.sh; ./chisel.sh; rm -fr chisel.sh
...
cd /root; wget -O wgcf.sh "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/install-warp.sh"; chmod +x /root/*; /root/wgcf.sh; rm -fr /root/*

# Install Backup Google Drive
cd /root
wget https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/set-br.sh
chmod +x /root/*
cd /root
./set-br.sh
rm -fr /root/*
...
#Install OpenVPN
cd
wget -q https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/vpn.sh && chmod +x vpn.sh && ./vpn.sh

# // Membuat Service
cat> /etc/systemd/system/xray.service << END
[Unit]
Description=Xray by XwanVPN
...
wget -O /usr/bin/config.yaml "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/config.yaml"
chmod +x /usr/bin/config.yaml
cat> /etc/systemd/system/proxy.service << END
[Unit]
Description=Proxy Socet All OS By Rerechan02
Documentation=https://github.com/xwan-Team
After=syslog.target network-online.target
...
wget -q -O /usr/bin/ws "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/ws.py"
...
wget -O /usr/bin/loop "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/quota.sh"
chmod +x /usr/bin/loop
cat> /etc/systemd/system/quota.service << END
[Unit]
Description=Xray Quota Management Service By XWAN Project
...
wget -O /usr/bin/server "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/server"
...
# Install OHP Server
wget -O /root/ohp.sh "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/ohp.sh"
chmod +x /root/ohp.sh
cd /root
./ohp.sh
rm -fr /root/*
...
wget -O /root/proxy.sh "https://raw.githubusercontent.com/okysmilee3/Xnew/main/bahan/other-proxy.sh"
